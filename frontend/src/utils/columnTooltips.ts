...
export const COLUMN_TOOLTIPS: Record<string, string> = {
  ...
  // Hours columns
  trainer_jibble_hours: 'Jibble hours logged by trainers — people who create tasks',
  reviewer_jibble_hours: 'Jibble hours logged by reviewers (POD Leads, Calibrators, Team Leads) — people who review tasks',
  logged_hours: 'Total Jibble hours (Trainer Hrs + Reviewer Hrs combined)',
  total_pod_hours: 'Jibble hours logged by reviewers (POD Leads, Calibrators, Team Leads)',
...
export const HEADER_TO_KEY_MAP: Record<string, string> = {
  ...
  'TrnrHrs': 'trainer_jibble_hours',
  'RvwrHrs': 'reviewer_jibble_hours',
  'POD': 'total_pod_hours',
